  ...
  return (
    <APIProvider apiKey={import.meta.env.VITE_GOOGLE_MAPS_API_KEY}>
      <div className="flex items-center justify-center">
        <div className="flex flex-row w-[430px] max-w-full h-screen overflow-y-hidden overflow-x-auto bg-white [&::-webkit-scrollbar]:hidden snap-x snap-mandatory sm:rounded-3xl sm:shadow-lg sm:shadow-black/20">
